...
ggplot(glm_percent, aes(x=year, y=percent, fill=location)) +
  geom_bar(stat="identity", position = position_dodge()) + geom_text(aes(label=c("*", "*", "*", "*", "", "","*","*","","")), size=5, position = position_dodge(0.9)) + xlab("Year") + ylab("Percent interaction") + scale_fill_manual(values=c( "#E69F00", "#F8766D"))
