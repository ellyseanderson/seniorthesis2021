...
glm9 <- glm(neighbor ~ enso + upwell + location + (1|filename) , data=glm_data, family= "binomial")
summary(glm9) #upwelling happening and location naples significant predictors of neighbor events 

glm10 <- glmer(neighbor ~ year + season , data=glm_data, family="binomial")
...
glm_data2<−lapply(glm_data2,as.numeric)
