...
ggplot(glm_percent, aes(x=year, y=percent, fill=location)) +
  geom_bar(position="dodge", stat="identity")+ geom_errorbar(aes(x=year, ymin=percent-SE, ymax=percent+SE),width=0.4) #error bars weird
...
```{r}
#next: error bars, figure out github pull/push issues
```
