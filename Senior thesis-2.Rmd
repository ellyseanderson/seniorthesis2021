...
ggplot(glm_3, aes(x=year, y=percent, fill=location)) +
  geom_bar(position="dodge", stat="identity") + ylab("Percent interaction")
...
ggplot(glm_percent, aes(x=percent, y=year.location, fill=year)) +
  geom_bar(position="dodge", stat="identity") + geom_text(aes(label=c("*", "*", "*", "*", "", "","*","*","","")), hjust=-1, size=5) + xlab("Percent interaction") + ylab("Year and location")  
